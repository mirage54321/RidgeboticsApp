                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      width: 84,
                      height: 84,
                      decoration: BoxDecoration(color: MatchColors.yellorLight, borderRadius: BorderRadius.circular(24)),
                      child: const Icon(Icons.query_stats, color: MatchColors.yellorDark, size: 40),
                    ),
                    const SizedBox(height: 24),
                    const Text('Team Stats & Match Center', textAlign: TextAlign.center, style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700)),
                    const SizedBox(height: 12),
                    Text(
                      "Track your team's upcoming matches with live countdowns and alerts, browse EPA and rankings across every team at your event, and simulate matchups before they happen.",
                      textAlign: TextAlign.center,
                      style: TextStyle(fontSize: 14, height: 1.5, color: Colors.grey[600]),
                    ),
                    const SizedBox(height: 32),
                    _feature(Icons.notifications_active_outlined, 'Match alerts', 'Get notified before your matches start'),
                    _feature(Icons.leaderboard_outlined, 'Team stats', 'EPA, rankings, and records for every team'),
                    _feature(Icons.compare_arrows, 'Matchup simulator', "Type in teams and see who's favored"),
                    const SizedBox(height: 32),
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        child: const Text('Add your team', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                      ),
                    ),
                  ],
                ),
