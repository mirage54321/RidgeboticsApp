...
How to use it: go to https://mirage54321.github.io/RidgeboticsApp/, pick one of the three tools, either upload a photo or sign up as a team, tap scan or log batteries, and wait a few seconds for the AI to return its findings — each one boxed directly on your photo so you can see exactly what it's talking about.
